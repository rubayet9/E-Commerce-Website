            ...
            <div className="flex md:flex-col gap-2 order-2 md:order-1 overflow-x-auto md:overflow-y-auto md:max-h-[500px]">
              {allImages.map((img, i) => (
                <button
                  ...
                  className={`relative w-16 h-20 bg-secondary border rounded-lg overflow-hidden flex-shrink-0 transition-all ${selectedImage === img ? "border-accent ring-2 ring-accent/20" : "border-border-custom hover:border-accent text-foreground/80"}`}
                >
